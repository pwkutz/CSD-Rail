...
class IntermediateFormat:
    ...
    def to_commonroad_scenario(self):
        ...
        print("scenario-->scenario_id", scenario.scenario_id)
        print("scenario-->not used id", scenario._id_counter)

        print("scenario-->lanelet_network._information", scenario.lanelet_network.information)
        print("scenario-->lanelet_network.lanelets", len(scenario.lanelet_network.lanelets))
        print("scenario-->lanelet_network._buffered_polygons", len(scenario.lanelet_network._buffered_polygons))
        print("scenario-->lanelet_network._strtee", len(scenario.lanelet_network._strtee))
        print("scenario-->lanelet_network._intersections", len(scenario.lanelet_network.intersections))
        print("scenario-->lanelet_network._strtee", len(scenario.lanelet_network._strtee))
        print("scenario-->lanelet_network._strtee", len(scenario.lanelet_network._strtee))
        print("scenario-->lanelet_network._traffic_lights", len(scenario.lanelet_network._traffic_lights))
        print("scenario-->lanelet_network.traffic_signs", len(scenario.lanelet_network._traffic_signs))
        print("scenario-->lanelet_network.areas", len(scenario.lanelet_network._areas))

        print("scenario-->_static_obstacles", len(scenario._static_obstacles))
        print("scenario-->_dynamic_obstacles", len(scenario._dynamic_obstacles))
        print("scenario-->_environment_obstacle", len(scenario._environment_obstacle))
        print("scenario-->_phantom_obstacle", len(scenario._phantom_obstacle))
        print("scenario-->id_set", len(scenario._id_set))
