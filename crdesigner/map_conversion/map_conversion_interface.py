...
def osm_to_commonroad(input_file: str) -> Scenario:
    ...
    print("osm_graph-->nodes", len(osm_graph.nodes))
    print("osm_graph-->edges", len(osm_graph.edges))
    print("osm_graph-->lanelinks", len(osm_graph.lanelinks))
    print("osm_graph-->center_point", len(osm_graph.center_point))
    print("osm_graph-->bounds", len(osm_graph.bounds))
    print("osm_graph-->traffic_signs", len(osm_graph.traffic_signs))
    print("osm_graph-->traffic_lights", len(osm_graph.traffic_lights))
