...
class OsmConfig(BaseConfig):
    ...
    # !!!! CHANGED !!!!!
    # !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
    LOAD_TUNNELS = Attribute(True, "Load Tunnels")
    ...
    #         "service": False, "path": False, "footway": False, "cycleway": False,
    #         "rail": False, "subway": False, "tram": False}, "Accepted Highways Mainlayer")

    ACCEPTED_HIGHWAYS_MAINLAYER = Attribute({"rail": True, "subway": True, "tram": True}, "Accepted Highways Mainlayer")
    ...
    #         "service": False, "path": True, "footway": True, "cycleway": True,
    #         "rail": True, "subway": True, "tram": True}, "Accepted Highways Sublayer")

    ACCEPTED_HIGHWAYS_SUBLAYER = Attribute({"rail": False, "subway": False, "tram": False}, "Accepted Highways Mainlayer")
    ...
    #                        "rail": 1, "subway": 1, "tram": 1}, "Lane Counts")

    LANECOUNTS = Attribute({"rail": 1, "subway": 1, "tram": 1}, "Lane Counts")
    ...
    #         "rail": 1.435, "subway": 1.435, "tram": 1.0},
    #        "Lane widths")

    LANEWIDTHS = Attribute({"rail": 1.435, "subway": 1.435, "tram": 1.0}, "Lane widths")
    ...
    #         "rail": 200, "subway": 80, "tram": 50},
    #        "Speed limits")

    SPEED_LIMITS = Attribute({"rail": 200, "subway": 80, "tram": 50}, "Speed limits")
    ...
    # delete short edges after cropping #INTERSTING. GIVES MORE LANES
    ...
    # INTERSECTION_CROPPING_WITH_RESPECT_TO_ROADS = Attribute(False, "Intersection Cropping with Respect to Roads")
    ...
    # CHANGED!!!
    ##########################################
    REMOVE_UNCONNECTED_LANELETS = Attribute(False, "Remove Unconnected Lanelets")
    ...
    TRAFFIC_SIGN_VALUES = ["traffic_signals","stop","switch", "buffer_stop","give_way", "city_limit", "signal"]
    # keys to search for in OSM
    # CHANGED!
    # TRAFFIC_SIGN_KEYS = ["traffic_sign", "overtaking", "traffic_signals:direction", "maxspeed"]
    TRAFFIC_SIGN_KEYS = ["traffic_sign", "overtaking", "railway:signal:direction",  "maxspeed"]
